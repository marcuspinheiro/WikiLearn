...
<!--  		<form method="get" action="Cadastro_postagem">
		...
		<a class="btn btn-primary" href="postagem.jsp" role="button">Criar sua Dúvida</a>
		<a class="btn btn-primary" href="lista_postagens.jsp" role="button">Visualizar dúvidas criadas</a>
