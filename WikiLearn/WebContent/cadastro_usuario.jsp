...
<section class="container-fluid">
		...
		<form class="needs-validation" method="get" action="Cadastro_usuario"
			...
			<section class="mb-3">
				...
				<section class="input-group">
					...
					<section class="invalid-feedback" style="width: 100%;">
						Nome de usuário obrigatório</section>
				</section>
			</section>
			...
			<section class="mb-3">
				...
				<section class="invalid-feedback">Por favor entre com um
					valor válido conforme indicado</section>
			</section>
			<section class="mb-3">
	...
	<section class="row">
		...
		<label for="data_nascimento">Deseja postar materiais/artigos na plataforma</label>
			...
			<h5 class="mb-3">Cadastro de currículo</h5>
			<h6 class="mb-3">Nesta parte do cadastro você deve informar os
				seus conhecimentos na área de tecnologia</h6>
			<label for="information">Informar 2 assuntos de maior
				conhecimento na área de tecnologia</label>
			<section class="row">
